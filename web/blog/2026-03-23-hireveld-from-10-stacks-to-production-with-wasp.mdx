---
title: "From 10 Failed Stacks to Production: How a Python Dev Built a Job Board with Wasp, a Full-Stack Framework for the Agentic Era"
authors: [matijasos]
...
*Marcel Coetzee is a data engineer and AI consultant based in South Africa. With a background in actuarial science and data science, he runs his own consultancy serving Big 4 audit firms — and builds SaaS products on the side. His latest project, [Hireveld](https://hireveld.com/), is a job board tackling South Africa's broken hiring market. He built it entirely with Wasp — after trying nearly every other stack out there.*

{/* truncate */}

## Tell us about yourself. How did you end up building web apps as a Python developer?

My path has been a bit unconventional. I started in actuarial science — insurance, risk modeling, that whole world. From there I moved into data science, then data engineering, and eventually into building products. Python has been my main language through all of that.

Today I run my own consultancy doing data engineering and AI work — one of the Big 4 auditors is a client. But I've always wanted to build my own things too, so I started learning the JavaScript ecosystem and working on SaaS products on the side. I'm not a JS native by any means, but with the rise of agentic coding tools, I realized I could finally turn my ideas into real full-stack applications without spending years mastering every corner of Node and React.

## What's Hireveld, and what problem are you solving?

[TODO: product image / gif, showing it in action]
...
[TODO: a bit more info on AI setup could be cool here - which tools exactly, tricks & tips, etc. A cool gif maybe of Claude or something?]
...
*Marcel Coetzee is a data engineer, AI consultant, and SaaS builder based in South Africa. You can check out Hireveld at [hireveld.com](https://hireveld.co.za/) and find him on [GitHub](https://github.com/Marcel-Coetzee).*
